...
public interface MaterialMapper {
	@Insert("insert into xjl_refactor_material(material_id,material_name,sample_picUrl) values(#{id},#{name}, #{samplePicUrl})")
	public int insert(Material material);
	@Select("select material_id as id,material_name as name,sample_picUrl as samplePicUrl from xjl_refactor_material")
	public List<Material> select();
	@Select("select xjl_refactor_material.material_id as id,xjl_refactor_material.material_name as name,xjl_refactor_material.sample_picUrl as samplePicUrl from xjl_refactor_material,xjl_refactor_flow_material where xjl_refactor_flow_material.flow_id=#{flowId} and xjl_refactor_material.material_id = xjl_refactor_flow_material.material_id")
